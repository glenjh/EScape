...
public class BackendRank
{
    ...
    {
        string rankUUID = "0d679a00-8887-11ee-acce-7fbb598f7ba2"; // Clear Day 랭크 테이블 uuid
        ...
        if (score == 20250000)
        {
            Debug.Log("클리어 날이 20250000(초기값)으로 랭킹 등록 실패");
            return;
        } // clearday(score) 값이 초기값일 경우 종료
    ...
    public void RankGet()
    {
        ...
        foreach (LitJson.JsonData jsonData in bro.FlattenRows())
        {
            ...
            info.AppendLine("클리어 날짜 : " + jsonData["score"].ToString());
